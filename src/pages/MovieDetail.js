    ...
    useEffect(() => {
        ...
        try {
            async function fetchMovie() {
                const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=f744f1312eda1fcfcad1680debc15d38`)
          ...
          <section className='flex justify-around flex-wrap py-5'>
              {loading ? <p className='dark:text-white text-lg'>Loading...</p> :
                  <>
                        ...
                        <div className='max-w-2xl text-gray-700 text-lg flex flex-col justify-left dark:text-white text-left'>
